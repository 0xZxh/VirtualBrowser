export default {
  ...
  browser: {
    ...
    jddjOrderStatus: 'Status',
    jddjOrderAmount: 'Amount',
    jddjOrderTime: 'Created',
    jddjFetchSuccess: 'Store data refreshed',
    jddjFetchFailed: 'Store fetch failed',
    jddjFetchTimeout: 'Store fetch timed out; please retry',
    jddjAutoSaveFailed: 'Failed to save auto-refresh setting',
    jddjEmpty: 'Not fetched',
    jddjSummaryTooltip: 'Shop / status / last fetch; click for orders',
